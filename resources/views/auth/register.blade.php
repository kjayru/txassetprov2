...
<div class="container" id="general2">
                ...
                <div class="card-body registercard ">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" required autocomplete="First name" autofocus>
