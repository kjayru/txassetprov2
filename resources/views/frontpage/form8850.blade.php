                ...
                <div class="card-body appliend sombra">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <hr>
                            <p>Job applicant: Fill in the lines below and check any boxes that apply. Complete only this
                                side.</p>
                        </div>

                    </div>

                    <form class="form" id="form-form8850" action="{{ route('front.thanks2') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="lienzo" id="form__8855">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12 col-12">
                                            <input type="text" name="yourname"
                                                class="form-control @error('socialnumber') is-invalid @enderror"
                                                id="yourname" value="{{ old('yourname') }}" required>
                                            @error('yourname')
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" name="socialnumber"
                                                class="form-control @error('socialnumber') is-invalid @enderror"
                                                id="socialnumber" value="{{ old('socialnumber') }}" required placeholder="">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" name="address"
                                                ...
                                                value="{{ old('address') }}" required autofocus id="address"
                                                placeholder="">
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" name="citystate"
                                                class="form-control  @error('citystate') is-invalid @enderror"
                                                value="{{ old('citystate') }}" required autofocus id="citystate"
                                                placeholder="">
                                            @error('citystate')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12 col-12">
                                            <input type="text" name="country"
                                                ...
                                                value="{{ old('country') }}" required placeholder="">
                                            @error('country')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input type="text" name="telephone"
                                                ...
                                                value="{{ old('telephone') }}" required placeholder="">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <legend class="col-form-label uppercase"> If you are under age 40, enter your date of
                                        birth (month, day, year)</legend>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4 col-12">
                                            ...
                                            <input type="text" name="birthday"
                                                ...
                                                value="{{ old('birthday') }}" required autofocus id="birthday"
                                                placeholder="">
                                            @error('birthday')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="condicional[]"
                                            value="1" id="opcion1">
                                        <label class="form-check-label" for="opcion1">
                                            Check here if you received a conditional certification from the state workforce
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="opcion2">
                                            <ul>
                                                <li>
                                                    I am a member of a family that has received assistance from Temporary
                                                    Assistance for Needy Families (TANF) for any 9
                                                    months during the past 18 months.
                                                </li>
                                                <li>
                                                    I am a veteran and a member of a family that received Supplemental
                                                    Nutrition Assistance Program (SNAP) benefits (food
                                                    stamps) for at least a 3-month period during the past 15 months.
                                                </li>
                                                <li>
                                                    I was referred here by a rehabilitation agency approved by the state, an
                                                    employment network under the Ticket to Work
                                                    program, or the Department of Veterans Affairs.
                                                </li>
                                                <li>
                                                    I am at least age 18 but not age 40 or older and I am a member of a
                                                    family that:<br>
                                                    a. Received SNAP benefits (food stamps) for the past 6 months; or<br>
                                                    b. Received SNAP benefits (food stamps) for at least 3 of the past 5
                                                    months, but is no longer eligible to receive them.
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    I received supplemental security income (SSI) benefits for any month
                                                    ending during the past 60 days.
                                                </li>
                                                <li>
                                                    I am a veteran and I was unemployed for a period or periods totaling at
                                                    least 4 weeks but less than 6 months during the
                                                    past year.
                                                </li>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="opcion3">
                                            Check here if you are a veteran and you were unemployed for a period or periods
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="opcion4">
                                            Check here if you are a veteran entitled to compensation for a service-connected
                                        ...
                                        <label class="form-check-label" for="opcion7">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    and the earliest 18-month period beginning
                                                    after August 5, 1997, ended during the past 2 years; or
                                                </li>
                                                <li>
                                                    Stopped being eligible for TANF payments during the past 2 years because
                                                    federal or state law limited the maximum time
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <p class="subtext">
                                        Under penalties of perjury, I declare that I gave the above information to the
                                        employer on or before the day I was offered a job, and it is, to the best of my
                                        knowledge, true,
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-4 text-center">
                                    ...
                                    <button type="submit"
                                        ...
                                        data-callback='onForm8850'
                                        data-action='submit' class=" g-recaptcha btn btn-danger btn-medium btn-form8850-submit">SUBMIT</button>
                                </div>
                            </div>
