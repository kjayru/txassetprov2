          ...
          <div class="container">
                    <div class="row">
                              <div class="col-md-8 ">
                                    ...
                                    <div class="detalle__video__player">
                                      <div class="encurso__video">
                                         ...
                                         <div class="encurso__video__player">
                                             ...
                                             <video id="my-homevideo" class="video-js" controls preload="auto" poster="/storage/{{@$curso->banner}}" data-setup="{}" >
                                                <source src="/storage/{{@$curso->video}}" type="video/mp4" />
                                ...
                                <div class="detalle__titulo mob__detalle">
                                    {{$curso->titulo}}
                                </div>
                                <div class="detalle__subtitulo mob__detalle">
                                       {{@$curso->responsable}}
                                </div>

                                <div class="detalle__costo mob__detalle">
                                ...
                                <div class="detalle__video mob__detalle">
                                    <div class="detalle__video__header">
                                              <a href="#" class="detalle__video__header__link detalle__header__home__course active" data-content="general">Information</a>
                                              <a href="#contenido" class="detalle__video__header__link detalle__header__home__course" data-content="secciones" data-id="{{$curso->id}}">Content</a>
                                    </div>
                                 </div>
                                 <div class="detalle__informacion interlineado mob__detalle">
                                    <strong>Course Information</strong>

                                    {!! $curso->contenido !!}
                                </div>

                                 <div class="detalle__contenido mob__detalle">
                                 ...
                                 <div id="contenido" class="detalle__secciones detalle__contenido mob__detalle">
