...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/admin/chapters/{{$content->chapter->course->id}}">Chapters</a></li>
              <li class="breadcrumb-item"><a href="/admin/chapters/{{$content->chapter->id}}">Chapters</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form" action="{{ route('chaptercontent.update',$content->id) }}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
