...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form role="form" action="{{ route('industries.update',$industry->id) }}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="card-footer">
                <a href="{{ route('industries.index') }}" class="btn btn-danger">Cancelar</a>
