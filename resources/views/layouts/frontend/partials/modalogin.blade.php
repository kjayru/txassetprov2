                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="email" id="email__login"
                                        placeholder="E-mail">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control" type="password" name="password" id="password__login"
                                        placeholder="Password">
                                    <span class="error error__password"></span>

                                    <a href="/password/reset" target="_blank" class=" btn__reset">Recover password</a>
                ...
                <div class="modal-footers">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-6 text-left">
                            Not account? <a href="#" class="btn__registro">sign up</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name-register"
                                        placeholder="Name">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" id="email-register"
                                        placeholder="E-mail">
...
<div class="modal fade" id="existeModal" tabindex="-1" role="dialog" aria-labelledby="existeModalTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn fondo__rojo btn__loginsumit btn__modal"
